...
const Impressum = () => {
  return (
    <div style={{ padding: '20px' }}>
      ...
      <p>
        DOUBLEBIT WEBDEV SRL<br />
        Str. Progresului, nr. 72, Piatra Neamț<br />
        Romania<br />
      </p>
      <h2>Kontakt</h2>
      <p>
        Telefon: +40755257576<br />
        E-Mail: contact@doublebit.net
      </p>
      <h2>Umsatzsteuer-ID</h2>
      <p>
        Umsatzsteuer-Identifikationsnummer gemäß §27 a Umsatzsteuergesetz: RO43181040
      </p>
